    ...
    <div className=" relative flex flex-col rounded-[9.6px] overflow-hidden">
      ...
      `}
        ...
        <div className="relative z-10 max-w-2xl px-6 md:px-10 lg:px-16 space-y-5">
          ...
          <button onClick={() => {
            const section = document.getElementById("ExploreAboutUs");
            if (section) {
              section.scrollIntoView({ behavior: "smooth" });
            }
          }} className="bg-white text-black font-bold py-3 px-8 rounded-full hover:bg-gray-200 hover:shadow-md transition duration-300 ease-in-out transform hover:scale-105">
            Explore About Us
          </button>
      ...
      {/* Bottom Section */}
      <div id="ExploreAboutUs" className="bg-[#A9A8A8] text-black p-6 md:p-10 leading-relaxed text-sm md:text-base">
        <p>
